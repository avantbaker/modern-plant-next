...
import { faUserCircle, faCartPlus, faBars, faTimes } from '@fortawesome/free-solid-svg-icons';
    ...
    <div id='header' className={`header ${className}`}>
      ...
      <div className='header__navigation--mobile'>
        <Link href='/mobile-navigation'>
          <FontAwesomeIcon className='header__icon header__navigation-open' icon={faBars} />
        </Link>
        <FontAwesomeIcon 
            onClick={() => Router.back() }
