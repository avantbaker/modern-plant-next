...
export default function SectionContent() {
    return (
        <div className="section-content">
            ...
            <h2 className="heading-2 mb-xl">Protected plant properties.</h2>
            <h5 className="heading-5 mb-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, quidem. Accusantium fugiat, nesciunt totam officiis.</h5>
            <p className="paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem, veniam iure harum alias, laudantium dignissimos, eaque minima magni non quia rerum magnam recusandae quaerat tenetur pariatur atque! Soluta, maxime laudantium! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam culpa totam a assumenda fugit aut eos quod vel officia tempore, fugiat, quisquam explicabo blanditiis accusamus quae maiores nemo in reiciendis. Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni perferendis quis quaerat itaque ex aspernatur voluptatem pariatur, quam magnam excepturi iusto doloribus molestias vitae provident ipsum minus minima modi corporis.</p>
            </div>
        </div>
    )
}
