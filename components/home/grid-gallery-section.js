    ...
    return (
        <div className="grid-gallery-section">
            <div className='grid-gallery-section__container container _80'>
                <FontAwesomeIcon className="grid-gallery-section__icon heading-2" icon={faInstagram} />
                <h3 className="heading-3">More of the good stuff.</h3>
                <h5 className="heading-5 mb-xxl">Follow us. We're bold purveyors of <br />wellness, and a proud modern apothecary </h5>
            </div>
            <GridGallery />
        </div>
    )
